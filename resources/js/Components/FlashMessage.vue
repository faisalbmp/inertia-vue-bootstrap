<template>
    ...
    <div>
        <div class="rounded-md bg-green-50 p-4" v-if="$page.props.flash.success && show">
            <div class="flex">
        ...
        <div class="rounded-md bg-red-50 p-4" v-if="($page.props.flash.error || Object.keys($page.props.errors).length > 0) && show">
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm font-medium text-red-800" v-if="$page.props.flash.error">
                        {{ $page.props.flash.error }}
                    </p>
                    <p v-else class="text-sm font-medium text-red-800">
